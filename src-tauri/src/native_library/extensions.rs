...
use super::{app_storage_root, repo_root, NativeExtensionListResponse, NativeExtensionManifest};
...
pub fn native_extensions() -> Result<NativeExtensionListResponse, String> {
    discover_extensions_from_dirs(user_extensions_dir(), extension_search_dirs(), true)
}

pub fn native_reload_extensions() -> Result<NativeExtensionListResponse, String> {
    native_extensions()
}
...
fn extension_manifest_payload(manifest_path: &Path, directory: &Path) -> NativeExtensionManifest {
...
fn discover_extensions_from_dirs(
...
) -> Result<NativeExtensionListResponse, String> {
    if create_user_dir {
    ...
    Ok(NativeExtensionListResponse {
