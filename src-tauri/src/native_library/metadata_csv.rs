...
use super::{
    app_storage_root, normalized_path_key, open_database, NativeCsvMetadataExportResponse,
    NativeCsvMetadataImportPreview, NativeCsvMetadataImportReportResponse,
    NativeCsvMetadataImportResponse, TRACK_COLUMNS,
};
...
pub fn native_import_metadata_csv(
    csv_path: Option<String>,
    track_ids: Option<Vec<i64>>,
    ...
    apply: Option<bool>,
    limit: Option<usize>,
) -> Result<NativeCsvMetadataImportResponse, String> {
    ...
    for (index, row) in rows.iter().enumerate() {
        ...
        let mut preview = NativeCsvMetadataImportPreview {
            row_number,
            track_id: None,
            path: None,
            matched: false,
    ...
    Ok(NativeCsvMetadataImportResponse {
...
#[allow(clippy::too_many_arguments)]
pub fn native_export_metadata_csv_import_report(
    csv_path: Option<String>,
    ...
    clear_blank_fields: Option<bool>,
    limit: Option<usize>,
) -> Result<NativeCsvMetadataImportReportResponse, String> {
    let response = native_import_metadata_csv(
        csv_path,
        track_ids,
        column_map,
        missing_only,
    ...
    Ok(NativeCsvMetadataImportReportResponse {
