...
pub(crate) fn native_update_album_artwork(
    album_id: i64,
    body: JsonValue,
) -> Result<Option<NativeAlbumArtworkUpdateResponse>, String> {
    ...
    Ok(Some(NativeAlbumArtworkUpdateResponse {
        album_id,
        artwork_path,
...
pub(crate) fn album_artwork_candidates(
    ...
    album_id: i64,
) -> Result<Vec<NativeAlbumArtworkCandidate>, String> {
...
fn push_candidate(
    candidates: &mut Vec<NativeAlbumArtworkCandidate>,
    seen: &mut Vec<String>,
    candidate: Option<NativeAlbumArtworkCandidate>,
) {
...
fn image_candidate(
...
) -> Option<NativeAlbumArtworkCandidate> {
    ...
    Some(NativeAlbumArtworkCandidate {
