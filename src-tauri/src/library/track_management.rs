...
pub fn delete_track(
    ...
    track_id: i64,
    delete_file: bool,
) -> Result<DesktopTrackDeleteResponse, String> {
    let response = delete_tracks(state, vec![track_id], delete_file)?;
    Ok(DesktopTrackDeleteResponse {
        track_id,
...
pub fn delete_tracks(
    ...
    track_ids: Vec<i64>,
    delete_file: bool,
) -> Result<DesktopTracksDeleteResponse, String> {
    ...
    if unique_ids.is_empty() {
        return Ok(DesktopTracksDeleteResponse {
    ...
    Ok(DesktopTracksDeleteResponse {
...
pub fn sync_track_metadata_from_files(
    _state: State<'_, DesktopLibraryState>,
    track_ids: Vec<i64>,
) -> Result<DesktopTrackMetadataSyncResponse, String> {
    ...
    Ok(DesktopTrackMetadataSyncResponse {
