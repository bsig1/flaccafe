...
pub struct DesktopTrack {
    ...
    pub(crate) analysis_mood: Option<String>,
    pub(crate) analysis_mood_confidence: Option<f64>,
    pub(crate) analysis_mood_tags: Option<String>,
...
pub struct DesktopClapGenreTagPreview {
    ...
    pub(crate) runner_up_genre: Option<String>,
    pub(crate) match_margin: Option<f64>,
    pub(crate) copy_blocked_reason: Option<String>,
