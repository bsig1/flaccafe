...
fn track_backup_json(track: &DesktopTrack, path_key: Option<String>) -> JsonValue {
    ...
    for field in TRACK_BACKUP_FIELDS {
        let value = match *field {
            ...
            "analysis_mood" => json!(track.analysis_mood.as_deref()),
            "analysis_mood_confidence" => json!(track.analysis_mood_confidence),
            "analysis_mood_tags" => json!(track.analysis_mood_tags.as_deref()),
