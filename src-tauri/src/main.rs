...
fn main() {
    let app = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            library::lyrics::track_lyrics_direct,
            library::lyrics::fetch_track_lyrics_direct,
            library::lyrics::lookup_lyrics_by_metadata_direct,
            library::lyrics::update_track_lyrics_direct,
            library::lyrics_bulk::start_bulk_lyrics_lookup_direct,
            library::lyrics_bulk::bulk_lyrics_lookup_progress_direct,
            library::lyrics_bulk::cancel_bulk_lyrics_lookup_direct,
            ...
            library::artist_info::save_artist_info_override,
