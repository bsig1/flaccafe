...
export type Page = "library" | "analysis" | "nowPlaying" | "artist" | "history" | "autodj" | "audiobooks" | "podcasts" | "fileManagement" | "settings";
...
export const defaultKeyboardShortcuts: Record<KeyboardShortcutAction, KeyboardShortcut> = {
  ...
  "page.history": { key: "7", ctrl: true, alt: false, shift: false },
  "page.autodj": { key: "8", ctrl: true, alt: false, shift: false },
  "page.fileManagement": { key: "9", ctrl: true, alt: false, shift: false },
  "page.settings": { key: "0", ctrl: true, alt: false, shift: false },
...
export function readUiPreferences(): UiPreferences {
  ...
  try {
    ...
    if (modern) {
      ...
      const validPages: Page[] = ["library", "analysis", "nowPlaying", "artist", "audiobooks", "podcasts", "history", "autodj", "fileManagement", "settings"];
      return {
        ...defaults,
        ...parsed,
