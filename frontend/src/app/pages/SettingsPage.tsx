...
import { LibraryPreferencesSection } from "./settings/LibraryPreferencesSection";
        ...
        <div className="grid max-w-3xl gap-5">
          ...
          {showSettingsSection("library preferences display ratings metadata startup theme font density sidebar width position alignment checkbox color colors roles preview checked unchecked accent podcasts file paths delete recycle remember") && (
            <LibraryPreferencesSection
              ...
              onWriteRatingsToFilesChange={onWriteRatingsToFilesChange}
              cdAutoLookupMetadata={cdAutoLookupMetadata}
              onCdAutoLookupMetadataChange={onCdAutoLookupMetadataChange}
              rememberedDeleteChoice={rememberedDeleteChoice}
              updateRememberedDeleteChoice={updateRememberedDeleteChoice}
