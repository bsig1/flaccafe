...
export function useAppController() {
  ...
  const playerNavigationHandlers = createPlayerNavigationHandlers({ albums, currentTrack, fetchAlbums, fetchArtistInfo, fetchArtistLocalTracks, findAlbumForTrack, handleSelectAlbum, primaryArtistName, setActivePage, setAlbums, setArtistInfo, setArtistTracks, setDebouncedSearch, setIsArtistLoading, setLibraryView, setSearch, setStatus, uiPreferences });
