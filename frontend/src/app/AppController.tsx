...
export function useAppController() {
  ...
  const playerNavigationHandlers = createPlayerNavigationHandlers({ albums, artistInfo, currentTrack, fetchAlbums, fetchArtistInfo, fetchArtistLocalTracks, findAlbumForTrack, handleSelectAlbum, primaryArtistName, splitArtistNames, saveArtistInfoOverride, setActivePage, setAlbums, setArtistInfo, setArtistTracks, setDebouncedSearch, setDetailTrack, setIsArtistLoading, setLibraryView, setSearch, setStatus, uiPreferences });
  const { handleOpenCurrentTrackFromPlayer, handleOpenCurrentArtistFromPlayer, handleOpenCurrentAlbumFromPlayer, loadArtistInfo, handleSaveArtistInfoOverride } = playerNavigationHandlers;
