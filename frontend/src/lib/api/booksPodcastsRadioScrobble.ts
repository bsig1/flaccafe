...
desktopFetchTrackResumeProgress,
...
export function fetchTrackResumeProgress(trackId: number): Promise<AudiobookProgressResponse | null> {
  return desktopFetchTrackResumeProgress(trackId);
}
